...
plot_simple <- ggplot(penguins_data_clean, aes(x=culmen_length_mm, y=culmen_depth_mm, color = species)) + geom_point() + geom_smooth() + scale_colour_manual(values = species_colours) + xlab("Culmen length (mm)") + ylab("Culmen depth (mm)") + theme_bw()
