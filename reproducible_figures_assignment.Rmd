...
#Factorising species as need factor for tukey test.
...
colnames(penguins_data_clean)
str(penguins_data_clean)
as.factor(penguins_data_clean$species)
str(penguins_data_clean)
...
posthocs_allspecies <- glht(allspecies_int_anova, linfct = mcp(species = "Tukey"))
