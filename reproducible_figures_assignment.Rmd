...
adelie_body_mass <- penguins_data_clean %>%
  filter(species == "Adelie") %>%
  select(species, body_mass_g) %>%
  remove_NA()

chinstrap_body_mass <- penguins_data_clean %>%
  filter(species == "Chinstrap") %>%
  select(species, body_mass_g) %>%
  remove_NA()

gentoo_body_mass <- penguins_data_clean %>%
...
ggplot(data = adelie_body_mass, aes(x=body_mass_g)) + geom_histogram(aes(color=species))
ggplot(data = chinstrap_body_mass, aes(x=body_mass_g)) + geom_histogram(aes(color=species))
ggplot(data = gentoo_body_mass, aes(x=body_mass_g)) + geom_histogram(aes(color=species))

#Transforming body mass data using log10 and square root to attempt to make data more normally distributed - unsuccessful.
ggplot(data = adelie_body_mass, aes(x=body_mass_g)) + geom_histogram(aes(color=species))
ggplot(data = adelie_body_mass, aes(x=body_mass_g)) + geom_histogram() + scale_x_log10()
ggplot(data = adelie_body_mass, aes(x=body_mass_g)) + geom_histogram() + scale_x_sqrt()

ggplot(data = chinstrap_body_mass, aes(x=body_mass_g)) + geom_histogram(aes(color=species))
ggplot(data = chinstrap_body_mass, aes(x=body_mass_g)) + geom_histogram() + scale_x_log10()
ggplot(data = chinstrap_body_mass, aes(x=body_mass_g)) + geom_histogram() + scale_x_sqrt()

ggplot(data = gentoo_body_mass, aes(x=body_mass_g)) + geom_histogram(aes(color=species))
ggplot(data = gentoo_body_mass, aes(x=body_mass_g)) + geom_histogram() + scale_x_log10()
ggplot(data = gentoo_body_mass, aes(x=body_mass_g)) + geom_histogram() + scale_x_sqrt()
