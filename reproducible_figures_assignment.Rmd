...
bill_size_exploratory <- ggplot(data=penguins_data_clean, aes(x=culmen_length_mm, y=culmen_depth_mm)) + geom_point(aes(color=species)) + scale_colour_manual(values = species_colours)
