...
Also, the axis labels are subpar, failing to properly explain the contents of the graph. For example, the y-axis label only states “body_mass_g”, but the information contained in this graph is actually the maximum body mass recorded on each island. 
