...
#This line allows R to find functions required to clean penguin data.
source(here("functions/cleaning_penguins_data.r"))
...
#Cleaning raw data to generate a cleaner dataset- removing unneeded variables and making data more easily read by R and by humans. Uses the cleaning_penguin_columns() function found in cleaning_penguins_data.r file.
