...
```{r Gentoo specific}
#Making a colour blind-friendly palette useful for distinguishing sexes on figures. Specifying this ensures each sex is represented by the same colours on any graph where sex-specific colours are specified, making this document more accessible (colour blind friendly) and more reproducible.
